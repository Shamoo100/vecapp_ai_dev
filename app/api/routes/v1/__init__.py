...
v1_router.include_router(tenant_routes.router, prefix="/tenants", tags=["tenants"])

# Include NEW consolidated follow-up routes (replaces feedback and followup_notes)
v1_router.include_router(followup_routes.router, tags=["followup"])

# TODO: Remove old routes after testing
# The following routes are now consolidated into followup_routes:
# - /feedback/* -> /followup/feedback
# - /followup-notes/* -> /followup/internal/generate
# - /visitor-followup/* -> /followup/internal/generate (event-driven)
...
__all__ = [
    ...
    #"example_ai_service", 
    "tenant_routes",
    "followup_routes",  # New consolidated routes
]